...
public class transportSolutionsModificarCaja extends javax.swing.JInternalFrame {

    public transportSolutionsModificarCaja() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("MODIFICAR CAJA");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/modificar_caja.png"))); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (txtId.getText().length() > 0) {
            if (txtDescripcion.getText().length() > 0) {
                ...
                cbd.modificarCaja(c, id);

                limpiar();
            } else {
                JOptionPane op = new JOptionPane("Debe ingresar id para modificar");
                op.setMessageType(JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane op = new JOptionPane("Debe buscar caja para modificar");
            op.setMessageType(JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void txtDescripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDescripcionActionPerformed
        ...
        CajaBD cbd = new CajaBD();
        String id = cbd.buscarIdCaja(txtDescripcion.getText().toUpperCase());
