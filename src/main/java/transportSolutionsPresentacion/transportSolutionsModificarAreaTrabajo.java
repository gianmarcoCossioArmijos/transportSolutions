...
public class transportSolutionsModificarAreaTrabajo extends javax.swing.JInternalFrame {

    public transportSolutionsModificarAreaTrabajo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("MODIFICAR AREA DE TRABAJO");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/modificar_area_trabajo.png"))); // NOI18N
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if (txtDescripcion.getText().length() > 0) {
            if (txtId.getText().length() > 0) {
                ...
                at.setDescripcion(txtDescripcion.getText().toUpperCase());
                int id = Integer.parseInt(txtId.getText());
                atbd.modificarAreaTrabajo(at, id);

                limpiar();
            } else {
                JOptionPane op = new JOptionPane("Debe buscar el area de trabajo antes de modificar");
    ...
    private void txtDescripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDescripcionActionPerformed
        ...
        AreaTrabajoBD atbd = new AreaTrabajoBD();
        String id = atbd.buscarAreaTrabajo(txtDescripcion.getText().toUpperCase());
