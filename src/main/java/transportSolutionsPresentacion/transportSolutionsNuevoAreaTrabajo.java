...
public class transportSolutionsNuevoAreaTrabajo extends javax.swing.JInternalFrame {

    public transportSolutionsNuevoAreaTrabajo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("NUEVA AREA DE TRABAJO");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/nueva_area_trabajo.png"))); // NOI18N
