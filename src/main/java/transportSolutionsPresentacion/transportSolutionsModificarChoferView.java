...
public class transportSolutionsModificarChoferView extends javax.swing.JInternalFrame {

    public transportSolutionsModificarChoferView() {
        initComponents();
        deshabilitar();
    }
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(txtDni, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 418, Short.MAX_VALUE)
                    .addComponent(txtTelefono, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 418, Short.MAX_VALUE)
                    ...
                    if (txtTelefono.getText().length() > 0) {
                        if (txtTipoLicencia.getText().length() > 0) {
                            if (txtLicencia.getText().length() > 0) {
                                ...
                                int id = Integer.parseInt(cbd.buscarIdChofer(dni));
                                cbd.modificarChofer(c, id);
