...
public class transportSolutionsNuevoClienteRUCView extends javax.swing.JInternalFrame {

    public transportSolutionsNuevoClienteRUCView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/nuevo_cliente_ruc.png"))); // NOI18N
    ...
    private void txtRucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRucActionPerformed
        ...
        if (txtRuc.getText().length() > 0) {
            ...
            if (tabla_temporal.getRowCount() > 0) {
                ...
                txtRuc.setText(tabla_temporal.getValueAt(0, 1).toString());
                txtRazonSocial.setText(tabla_temporal.getValueAt(0, 2).toString());
                ...
                JOptionPane op = new JOptionPane("El cliente ya se encuentra registrado");
                op.setMessageType(JOptionPane.WARNING_MESSAGE);
            }
        } else {
